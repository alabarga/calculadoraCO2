...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Consumo.recurso'
        db.delete_column('co2_consumo', 'recurso_id')

        # Adding field 'Consumo.medida'
        db.add_column('co2_consumo', 'medida',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['co2.Medida']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Consumo.recurso'
        db.add_column('co2_consumo', 'recurso',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['co2.Recurso']),
                      keep_default=False)

        # Deleting field 'Consumo.medida'
        db.delete_column('co2_consumo', 'medida_id')
    ...
    models = {
        ...
        'co2.consumo': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 11, 16, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
